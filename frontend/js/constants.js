const contractAddress = "0xbe91acF414CD2F59c2DebDD7F4Eb439DB28C7230"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = "The Ancient Creature is a collection of 3999 NFT with unique images. It cost 10 MATIC to mint one NFT. Whoever owns a nft now will get exclusive NFT in second version of Ancient Creature and crypto token airdrop. Staking NFT also will be available soon. NFT owners will also get exclusive discounts for merch wich will be release soon. Don't miss out this chance. Let's Goo";
